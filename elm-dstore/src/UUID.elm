...
{-| This module is a modified version of [TSFoster/elm-uuid](https://package.elm-lang.org/packages/TSFoster/elm-uuid/4.2.0).
...
toComparable : UUID -> List Int
toComparable (UUID a b c d) =
    [ a, b, c, d ]
